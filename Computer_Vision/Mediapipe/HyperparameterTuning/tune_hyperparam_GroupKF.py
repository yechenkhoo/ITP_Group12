...
python -m HyperparameterTuning.tune_hyperparam_GroupKF
"""
...
def main():
    ...
    for architecture in architectures:
        ...
        path_csv = "dataset4_grouped.csv"
        test_run_name = "hypt_kt_groupKfold_bayes_layers"
        ...
        if 'cnn' in architecture:
            ...
            data.split_dataset_by_fixed_test_group(test_size=0.2, reshape=True, random_state=42)
        else:
            print("[INFO] MLP architecture detected - using flattened input (132 features)")
            data.split_dataset_by_fixed_test_group(test_size=0.2, reshape=False, random_state=42)

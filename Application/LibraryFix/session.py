...
from db_connection import MONGO_SESSIONS_COLLECTION  # Import the collection object
from db_connection import MONGO_SESSIONS_TTL
...
class SessionStore(SessionBase):
    ...
    def __init__(self, session_key=None):
        ...
        self.db_collection = MONGO_SESSIONS_COLLECTION
    ...
    def delete(self, session_key=None):
        if session_key is None:
            if self._session_key is None:
                return
            session_key = self.session_key
        self.db_collection.delete_one({'session_key': session_key})
